...
{
    #[Route('/new/{projectId}', name: 'app_status_new', methods: ['GET' , 'POST'])]
    #[Route('/edit/{projectId}/{id}', name: 'app_status_edit', methods: ['GET' , 'POST'])]
    public function index(#[MapEntity(mapping: ['projectId' => 'id'])] ?Project $project, ?Status $status, Request $request, EntityManagerInterface $manager): Response
    {
        ...
        return $this->render('restricted/status/new.html.twig', [
